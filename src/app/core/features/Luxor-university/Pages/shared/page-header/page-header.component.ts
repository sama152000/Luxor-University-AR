...
export class PageHeaderComponent implements OnInit {
  ...
  private getPageConfig(url: string): {
    title: string;
    ...
    const configMap: { [key: string]: any } = {
      ...
      '/sectors': {
        title: 'قطاعات الجامعة',
        breadcrumbs: [{ label: 'القطاعات', url: '/sectors' }],
      },
      '/sectors-overview': {
        title: 'نظرة عامة على القطاعات',
        breadcrumbs: [{ label: 'القطاعات', url: '/sectors' }],
      },
      ...
      '/faculties': {
        ...
        breadcrumbs: [{ label: 'الكليات', url: '/faculties' }],
      },
      '/about': {
        title: 'عن الجامعة',
        breadcrumbs: [{ label: 'عن الجامعة', url: '/about' }],
      },
      '/news': {
        title: 'الأخبار والإعلانات',
        breadcrumbs: [{ label: 'الأخبار', url: '/news' }],
      },
      '/Departments': {
        title: 'الإدارات',
        breadcrumbs: [{ label: 'الإدارات', url: '/Departments' }],
      },
      '/org-structure': {
        title: 'الهيكل التنظيمي',
        breadcrumbs: [
          { label: 'الهيكل التنظيمي', url: '/organizational-structure' },
        ],
      },
      ...
      '/all-news': {
        ...
        breadcrumbs: [
          ...
          { label: 'جميع الأخبار', url: '/all-news' },
        ],
      },
      '/student-life': {
        title: 'الحياة الطلابية',
        breadcrumbs: [{ label: 'الحياة الطلابية', url: '/student-life' }],
      },
      '/healthcare': {
        title: 'الخدمات الصحية',
        breadcrumbs: [{ label: 'الرعاية الصحية', url: '/healthcare' }],
      },
      '/contact-us': {
        title: 'تواصل معنا',
        breadcrumbs: [{ label: 'تواصل معنا', url: '/contact-us' }],
      },
      '/OrganizationalStructure': {
        title: 'الهيكل التنظيمي',
        breadcrumbs: [
          { label: 'الهيكل التنظيمي', url: '/OrganizationalStructure' },
        ],
      },
      '/Center-list': {
        title: 'مراكز الجامعة',
        breadcrumbs: [{ label: 'المراكز' }],
      },
    };
    ...
    if (url.includes('/centers/')) {
      return {
        title: 'تفاصيل المركز',
        breadcrumbs: [{ label: 'المراكز', url: '/Center-list' }],
      };
    }
